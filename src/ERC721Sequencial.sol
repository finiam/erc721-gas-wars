...
// Forked from: OpenZeppelin Contracts v0.8.10 (token/ERC721/ERC721.sol)
...
contract ERC721Sequencial is Context, ERC165, IERC721, IERC721Metadata {
   ...
   */
  function _safeMint(address to, bytes memory _data) internal virtual returns (uint256 tokenId) {
    tokenId = _mint(to);
    require(
